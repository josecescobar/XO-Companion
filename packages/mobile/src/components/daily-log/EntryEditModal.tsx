...
const styles = StyleSheet.create({
  ...
  pickerButton: { borderRadius: 8, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 12 },
  pickerText: { fontSize: 16 },
  actions: { gap: 12, marginTop: 8, marginBottom: 16 },
  deleteBtn: { borderRadius: 10, borderWidth: 1, paddingVertical: 14, alignItems: 'center' },
